 ...
 */
function theme_learnmoodle_set_logo($css, $logo) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return bool
 */
function theme_learnmoodle_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM and $filearea === 'logo') {
        $theme = theme_config::load('learnmoodle');
 ...
 */
function theme_learnmoodle_set_customcss($css, $customcss) {
...
/**
 * All theme functions should start with theme_learnmoodle_
 * @deprecated since 2.5.1
 */
function learnmoodle_process_css() {
 ...
 * @deprecated since 2.5.1
 */
function learnmoodle_set_customcss() {
    throw new coding_exception('Please call theme_'.__FUNCTION__.' instead of '.__FUNCTION__);
}
